...
export default function VendaCancelada() {
    return(
        <div className={poppins.className + " relative w-screen min-h-screen flex bg-[#F2EBD5] text-black overflow-hidden"}>
            ...
            <div className="flex flex-col justify-center items-center text-center w-full">
                <FaCheck size={60} />
                <h1 className="text-6xl mb-10 mt-5">Venda Cancelada!</h1>
                <Link href="/vendas-efetuadas" className="bg-[#F2594B] text-[#F2EBD5] text-xl p-1 w-50 rounded-md hover:shadow-xl">
                    Voltar
                </Link>
            </div>
        </div>
