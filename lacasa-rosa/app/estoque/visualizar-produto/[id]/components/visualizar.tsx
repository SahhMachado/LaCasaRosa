...
export default function Visualizar({ produto }: { produto: ProdutoProps }) {
    ...
    return (
        <div>
            ...
            <form action={handleSubmit} className="mb-5">
                    ...
                    <label className="relative">
                        ...
                        <div className="w-25 h-25 rounded-full bg-[#F2594B] text-[#F2EBD5] 
                            ...
                            {preview ? (
                                ...
                                <img
                                    src={`data:image/jpeg;base64,${produto.produto_imagem}`}
                                    alt="Foto de perfil"
                                    className="w-full h-full rounded-full object-cover"
                                />
                            ) : (
                ...
                />
                <label>Nome:</label>
                <input readOnly placeholder="Informe o nome do produto aqui..."
                ...
                <input readOnly defaultValue={produto.produto_estoque}
                ...
                <label>Tamanho:</label>
                <input readOnly placeholder="Informe o tamanho aqui..."
                ...
                <input readOnly placeholder="Exemplo: Blusas, Calças, Sapatos"
                ...
                <select disabled name="situacao" className="w-full mb-10 outline-none
                                    appearance-none bg-[#F2C84B] font-bold text-[#F2594B] rounded-md h-auto px-3 p-1 shadow-md"
                    defaultValue={produto.produto_status}>
                ...
                <div className="pointer-events-none absolute right-12 bottom-39 flex items-center">
