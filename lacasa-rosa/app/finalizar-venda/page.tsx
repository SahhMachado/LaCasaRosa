            ...
            <div className="relative z-10 flex flex-col flex-1">
                ...
                <div className="h-141 ml-45 mr-45 overflow-y-auto overflow-x-hidden text-[#F2EBD5] font-bold">
                    <div className="bg-[#F25EA3] h-20 rounded-lg border-2 border-[#F2EBD5] mb-10 
                        ...
                        <p className="mr-60 2xl:mr-100">Blusinha Rosy</p>
                        <p  className="mr-55 2xl:mr-70">R$ 24,90</p>
                        <p  className="mr-30 2xl:mr-80">1 un.</p>
                    ...
                    <div className="bg-[#F25EA3] h-20 rounded-lg border-2 border-[#F2EBD5] mb-10
                        ...
                        <p className="mr-60 2xl:mr-100">Produto XXX</p>
                        <p  className="mr-55 2xl:mr-70">R$ 00,00</p>
                        <p  className="mr-30 2xl:mr-80">1 un.</p>
                         <button className="mr-5 hover:scale-110">
                            <BsPlusSquareFill size={25} />
                        </button>
                ...
                <div className="flex text-center items-center font-bold">
                    <span className="bg-[#F2594B] text-[#F2EBD5] p-2 absolute z-10 text-center items-center right-90 2xl:right-92 mt-7">
                    ...
                    <span className="bg-[#F2594B] text-[#F2EBD5] p-2 absolute flex text-center items-center gap-x-5 right-48 2xl:right-50 mt-7">
                        <p>Total:</p>
                        <p>R$ 124,90</p>
                    </span>
                </div>
                ...
                <div className="flex items-center ml-45 gap-x-90 mt-20 2xl:mt-4 2xl:gap-x-150">
                    ...
                    <button id="concluir" className="bg-[#F2C84B] w-50 p-2 font-bold text-[#F2594B] text-lg rounded-md
